    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div className="text-center space-y-2">
                <h1 className="text-4xl md:text-5xl font-bold text-text-main dark:text-dark-text-main">Your Watchlist</h1>
            ...
            <div className="max-w-xl mx-auto bg-card dark:bg-dark-card p-4 rounded-xl border border-border dark:border-dark-border space-y-3">
                 <h2 className="font-semibold text-text-main dark:text-dark-text-main">Add New Asset</h2>
