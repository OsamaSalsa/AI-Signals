...
export const INITIAL_WATCHLIST_ASSETS: string[] = ['Gold (XAU/USD)', 'Bitcoin (BTCUSD)', 'EUR/USD', 'Dow Jones (DJI / US30)', 'Tesla (TSLA)'];

export const ASSETS: Asset[] = [
  // Stocks
  { name: 'Apple (AAPL)', category: AssetCategory.STOCKS },
  { name: 'Microsoft (MSFT)', category: AssetCategory.STOCKS },
  { name: 'Amazon (AMZN)', category: AssetCategory.STOCKS },
  { name: 'Alphabet (GOOGL)', category: AssetCategory.STOCKS },
  { name: 'Meta Platforms (META)', category: AssetCategory.STOCKS },
  { name: 'Tesla (TSLA)', category: AssetCategory.STOCKS },
  { name: 'NVIDIA (NVDA)', category: AssetCategory.STOCKS },
  { name: 'Berkshire Hathaway (BRK.B)', category: AssetCategory.STOCKS },
  { name: 'Johnson & Johnson (JNJ)', category: AssetCategory.STOCKS },
  { name: 'JPMorgan Chase & Co. (JPM)', category: AssetCategory.STOCKS },
  { name: 'Visa (V)', category: AssetCategory.STOCKS },
  { name: 'Walmart (WMT)', category: AssetCategory.STOCKS },
  { name: 'Procter & Gamble (PG)', category: AssetCategory.STOCKS },
  { name: 'UnitedHealth Group (UNH)', category: AssetCategory.STOCKS },
  { name: 'Exxon Mobil (XOM)', category: AssetCategory.STOCKS },
  // Crypto
